...
-- The command to start a browser.
myBrowser = "google-chrome-stable"

-- The command to use as a launcher, to launch commands that don't have
-- preset keybindings.
myLauncher = "dmenu_run -fn 'SF Pro Display-10'"
...
myFont      = "xft:SF Pro Display:size=9:antialias=true"
myBigFont   = "xft:SF Pro Display:size=9:antialias=true"
myWideFont  = "xft:SF Pro Display:style=Regular"
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  -- TS Not sure what the point of this is when you can just use movement keys
  -- to move around the group's tabs. So disabling it to enable alt + tab
  -- between workspaces
